...
samples:
	...
	@PATH=.:$$PATH; protoc --jsonschema_out=jsonschemas --proto_path=testdata/proto testdata/proto/Timestamp.proto 2>/dev/null || echo "No messages found (Timestamp.proto)"
